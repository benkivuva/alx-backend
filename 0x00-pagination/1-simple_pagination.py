...
"""
This module provides a function for calculating the start and end indices for pagination
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Retrieve a page of the dataset based on the provided page and page_size.
